  ...
  return (_flatMap$find = [schema.astNode, ...schema.extensionASTNodes]
    .flatMap(
      ...
      (schemaNode) => {
        ...
        return /* c8 ignore next */ (_schemaNode$operation =
...
function getAllImplementsInterfaceNodes(type, iface) {
  ...
  return nodes
    .flatMap((typeNode) => {
      ...
      return /* c8 ignore next */ (_typeNode$interfaces =
        typeNode.interfaces) !== null && _typeNode$interfaces !== void 0
...
function getUnionMemberTypeNodes(union, typeName) {
  ...
  return nodes
    .flatMap((unionNode) => {
      ...
      return /* c8 ignore next */ (_unionNode$types = unionNode.types) !==
        null && _unionNode$types !== void 0
        ? _unionNode$types
        : [];
    })
